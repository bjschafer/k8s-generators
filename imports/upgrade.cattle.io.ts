...
export interface PlanSpec {
   ...
   *
   * @schema PlanSpec#postCompleteLabels
   */
  readonly postCompleteLabels?: { [key: string]: string };
...
export function toJson_PlanSpec(obj: PlanSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'postCompleteLabels': ((obj.postCompleteLabels) === undefined) ? undefined : (Object.entries(obj.postCompleteLabels).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
