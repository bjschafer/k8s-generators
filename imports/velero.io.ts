 ...
 *
 *
 * @schema ResticRepository
 */
export class ResticRepository extends ApiObject {
  /**
   * Returns the apiVersion and kind for "ResticRepository"
   */
  public static readonly GVK: GroupVersionKind = {
    apiVersion: 'velero.io/v1',
  ...
  /**
   * Renders a Kubernetes manifest for "ResticRepository".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: ResticRepositoryProps = {}): any {
    return {
      ...ResticRepository.GVK,
      ...toJson_ResticRepositoryProps(props),
    };
  }

  /**
   * Defines a "ResticRepository" API object
   * @param scope the scope in which to define this object
   * @param id a scope-local name for the object
   * @param props initialization props
   */
  public constructor(scope: Construct, id: string, props: ResticRepositoryProps = {}) {
    super(scope, id, {
      ...ResticRepository.GVK,
      ...props,
    });
  ...
  public toJson(): any {
    ...
    return {
      ...ResticRepository.GVK,
      ...toJson_ResticRepositoryProps(resolved),
    };
  }
}
 ...
 * @schema ResticRepository
 */
export interface ResticRepositoryProps {
  /**
   * @schema ResticRepository#metadata
   */
  readonly metadata?: ApiObjectMetadata;
   ...
   *
   * @schema ResticRepository#spec
   */
  readonly spec?: ResticRepositorySpec;

}

/**
 * Converts an object of type 'ResticRepositoryProps' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ResticRepositoryProps(obj: ResticRepositoryProps | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'metadata': obj.metadata,
    'spec': toJson_ResticRepositorySpec(obj.spec),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * ResticRepositorySpec is the specification for a ResticRepository.
 *
 * @schema ResticRepositorySpec
 */
export interface ResticRepositorySpec {
  /**
   * BackupStorageLocation is the name of the BackupStorageLocation that should contain this repository.
   *
   * @schema ResticRepositorySpec#backupStorageLocation
   */
  readonly backupStorageLocation: string;
   ...
   * MaintenanceFrequency is how often maintenance should be run.
   *
   * @schema ResticRepositorySpec#maintenanceFrequency
   */
  readonly maintenanceFrequency: string;
   ...
   * ResticIdentifier is the full restic-compatible string for identifying this repository.
   *
   * @schema ResticRepositorySpec#resticIdentifier
   */
  readonly resticIdentifier: string;
   ...
   *
   * @schema ResticRepositorySpec#volumeNamespace
   */
  readonly volumeNamespace: string;
...
/**
 * Converts an object of type 'ResticRepositorySpec' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ResticRepositorySpec(obj: ResticRepositorySpec | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'backupStorageLocation': obj.backupStorageLocation,
    'maintenanceFrequency': obj.maintenanceFrequency,
