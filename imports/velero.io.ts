...
export enum DownloadRequestSpecTargetKind {
  ...
  /** BackupItemSnapshots */
  BACKUP_ITEM_SNAPSHOTS = "BackupItemSnapshots",
  /** BackupResourceList */
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_ResticRepositoryProps(
  obj: ResticRepositoryProps | undefined
): Record<string, any> | undefined {
  if (obj === undefined) {
    return undefined;
  }
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_ResticRepositorySpec(
  obj: ResticRepositorySpec | undefined
): Record<string, any> | undefined {
  if (obj === undefined) {
    return undefined;
  }
