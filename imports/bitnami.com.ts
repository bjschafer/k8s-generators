...
export function toJson_SealedSecretProps(
  obj: SealedSecretProps | undefined
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_SealedSecretSpec(
  obj: SealedSecretSpec | undefined
): Record<string, any> | undefined {
  if (obj === undefined) {
    return undefined;
  }
  const result = {
    ...
    encryptedData:
      obj.encryptedData === undefined
        ? undefined
        : Object.entries(obj.encryptedData).reduce(
            (r, i) => (i[1] === undefined ? r : { ...r, [i[0]]: i[1] }),
            {}
          ),
 ...
 */
/* eslint-disable max-len, quote-props */
export function toJson_SealedSecretSpecTemplate(
  obj: SealedSecretSpecTemplate | undefined
): Record<string, any> | undefined {
  if (obj === undefined) {
    return undefined;
  }
