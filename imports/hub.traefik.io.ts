...
export interface ApiSpecOpenApiSpec {
   ...
   *
   * @schema ApiSpecOpenApiSpec#validateRequestBodySchema
   */
  readonly validateRequestBodySchema?: boolean;
...
export function toJson_ApiSpecOpenApiSpec(obj: ApiSpecOpenApiSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'path': obj.path,
    'url': obj.url,
    'validateRequestBodySchema': obj.validateRequestBodySchema,
 ...
 * @schema APIAuth
 */
export class ApiAuth extends ApiObject {
  /**
   * Returns the apiVersion and kind for "APIAuth"
   */
  public static readonly GVK: GroupVersionKind = {
    apiVersion: 'hub.traefik.io/v1alpha1',
    kind: 'APIAuth',
  ...
  /**
   * Renders a Kubernetes manifest for "APIAuth".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: ApiAuthProps = {}): any {
    return {
      ...ApiAuth.GVK,
      ...toJson_ApiAuthProps(props),
    };
  }

  /**
   * Defines a "APIAuth" API object
   * @param scope the scope in which to define this object
   * @param id a scope-local name for the object
   * @param props initialization props
   */
  public constructor(scope: Construct, id: string, props: ApiAuthProps = {}) {
    super(scope, id, {
      ...ApiAuth.GVK,
      ...props,
    });
...
export function toJson_ApiAuthProps(obj: ApiAuthProps | undefined): Record<string, any> | undefined {
  ...
  const result = {
    'metadata': obj.metadata,
    'spec': toJson_ApiAuthSpec(obj.spec),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
...
export interface ApiAuthSpec {
   ...
   *
   * @schema ApiAuthSpec#apiKey
   */
  readonly apiKey?: ApiAuthSpecApiKey;
...
export function toJson_ApiAuthSpec(obj: ApiAuthSpec | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'apiKey': toJson_ApiAuthSpecApiKey(obj.apiKey),
 ...
 * APIKey configures API key authentication.
 *
 * @schema ApiAuthSpecApiKey
 */
export interface ApiAuthSpecApiKey {
  /**
   ...
   *
   * @schema ApiAuthSpecApiKey#keySource
   */
  readonly keySource?: ApiAuthSpecApiKeyKeySource;

}

/**
 * Converts an object of type 'ApiAuthSpecApiKey' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ApiAuthSpecApiKey(obj: ApiAuthSpecApiKey | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'keySource': toJson_ApiAuthSpecApiKeyKeySource(obj.keySource),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
...
export interface ApiAuthSpecJwt {
   ...
   *
   * @schema ApiAuthSpecJwt#appIdClaim
   */
  readonly appIdClaim: string;

  /**
   * ForwardHeaders specifies additional headers to forward with the request.
   *
   * @schema ApiAuthSpecJwt#forwardHeaders
   */
  readonly forwardHeaders?: { [key: string]: string };
   ...
   *
   * @schema ApiAuthSpecJwt#stripAuthorizationHeader
   */
  readonly stripAuthorizationHeader?: boolean;
   ...
   *
   * @schema ApiAuthSpecJwt#tokenNameClaim
   */
  readonly tokenNameClaim?: string;
...
export function toJson_ApiAuthSpecJwt(obj: ApiAuthSpecJwt | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'appIdClaim': obj.appIdClaim,
    'forwardHeaders': ((obj.forwardHeaders) === undefined) ? undefined : (Object.entries(obj.forwardHeaders).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {})),
    'jwksFile': obj.jwksFile,
    'jwksUrl': obj.jwksUrl,
    'publicKey': obj.publicKey,
    'signingSecretName': obj.signingSecretName,
    'stripAuthorizationHeader': obj.stripAuthorizationHeader,
 ...
 * When specified, it completely overrides defaults - fields left empty will disable that extraction method.
 *
 * @schema ApiAuthSpecApiKeyKeySource
 */
export interface ApiAuthSpecApiKeyKeySource {
  /**
   * Header is the name of the header containing the API key.
   *
   * @schema ApiAuthSpecApiKeyKeySource#header
   */
  readonly header?: string;
   ...
   *
   * @schema ApiAuthSpecApiKeyKeySource#headerAuthScheme
   */
  readonly headerAuthScheme?: string;
   ...
   *
   * @schema ApiAuthSpecApiKeyKeySource#query
   */
  readonly query?: string;
...
/**
 * Converts an object of type 'ApiAuthSpecApiKeyKeySource' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ApiAuthSpecApiKeyKeySource(obj: ApiAuthSpecApiKeyKeySource | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'header': obj.header,
    'headerAuthScheme': obj.headerAuthScheme,
...
export interface ApiPortalSpec {
   ...
   *
   * @schema ApiPortalSpec#auth
   */
  readonly auth?: ApiPortalSpecAuth;
...
export function toJson_ApiPortalSpec(obj: ApiPortalSpec | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'auth': toJson_ApiPortalSpecAuth(obj.auth),
    'description': obj.description,
    'title': obj.title,
 ...
 *
 * @schema APIPortalAuth
 */
export class ApiPortalAuth extends ApiObject {
  /**
   * Returns the apiVersion and kind for "APIPortalAuth"
   */
  public static readonly GVK: GroupVersionKind = {
    apiVersion: 'hub.traefik.io/v1alpha1',
    kind: 'APIPortalAuth',
  ...
  /**
   * Renders a Kubernetes manifest for "APIPortalAuth".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: ApiPortalAuthProps = {}): any {
    return {
      ...ApiPortalAuth.GVK,
      ...toJson_ApiPortalAuthProps(props),
    };
  }

  /**
   * Defines a "APIPortalAuth" API object
   * @param scope the scope in which to define this object
   * @param id a scope-local name for the object
   * @param props initialization props
   */
  public constructor(scope: Construct, id: string, props: ApiPortalAuthProps = {}) {
    super(scope, id, {
      ...ApiPortalAuth.GVK,
      ...props,
    });
  ...
  public toJson(): any {
    ...
    return {
      ...ApiPortalAuth.GVK,
      ...toJson_ApiPortalAuthProps(resolved),
    };
  }
}
 ...
 * @schema APIPortalAuth
 */
export interface ApiPortalAuthProps {
  /**
   * @schema APIPortalAuth#metadata
   */
  readonly metadata?: ApiObjectMetadata;
...
export function toJson_ApiPortalAuthProps(obj: ApiPortalAuthProps | undefined): Record<string, any> | undefined {
  ...
  const result = {
    'metadata': obj.metadata,
    'spec': toJson_ApiPortalAuthSpec(obj.spec),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * OIDC configures the OIDC authentication.
 *
 * @schema ApiPortalAuthSpecOidc
 */
export interface ApiPortalAuthSpecOidc {
  /**
   * Claims configures JWT claim mappings for user attributes.
   *
   * @schema ApiPortalAuthSpecOidc#claims
   */
  readonly claims: ApiPortalAuthSpecOidcClaims;

  /**
   * IssuerURL is the OIDC provider issuer URL.
   *
   * @schema ApiPortalAuthSpecOidc#issuerUrl
   */
   ...
   *
   * @schema ApiPortalAuthSpecOidc#scopes
   */
  readonly scopes?: string[];
   ...
   *
   * @schema ApiPortalAuthSpecOidc#secretName
   */
  readonly secretName: string;
...
export function toJson_ApiPortalAuthSpecOidc(obj: ApiPortalAuthSpecOidc | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'claims': toJson_ApiPortalAuthSpecOidcClaims(obj.claims),
...
export interface ApiPortalAuthSpecOidcClaims {
   ...
   *
   * @schema ApiPortalAuthSpecOidcClaims#email
   */
  readonly email?: string;
   ...
   *
   * @schema ApiPortalAuthSpecOidcClaims#firstname
   */
  readonly firstname?: string;
   ...
   *
   * @schema ApiPortalAuthSpecOidcClaims#groups
   */
  readonly groups: string;
   ...
   *
   * @schema ApiPortalAuthSpecOidcClaims#lastname
   */
  readonly lastname?: string;
 ...
 */
export enum ApiPortalAuthSpecOidcSyncedAttributes {
  /** groups */
  GROUPS = "groups",
  /** userId */
  USER_ID = "userId",
...
export interface ApiVersionSpecOpenApiSpec {
   ...
   * This option overrides the default behavior configured in the static configuration.
   *
   * @schema ApiVersionSpecOpenApiSpec#validateRequestBodySchema
   */
  readonly validateRequestBodySchema?: boolean;
 ...
 * @schema ContentItem
 */
export class ContentItem extends ApiObject {
  /**
   * Returns the apiVersion and kind for "ContentItem"
   */
  public static readonly GVK: GroupVersionKind = {
    apiVersion: 'hub.traefik.io/v1alpha1',
    kind: 'ContentItem',
  ...
  /**
   * Renders a Kubernetes manifest for "ContentItem".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: ContentItemProps = {}): any {
    return {
      ...ContentItem.GVK,
      ...toJson_ContentItemProps(props),
    };
  }

  /**
   * Defines a "ContentItem" API object
   * @param scope the scope in which to define this object
   * @param id a scope-local name for the object
   * @param props initialization props
   */
  public constructor(scope: Construct, id: string, props: ContentItemProps = {}) {
    super(scope, id, {
      ...ContentItem.GVK,
      ...props,
    });
  ...
  public toJson(): any {
    ...
    return {
      ...ContentItem.GVK,
      ...toJson_ContentItemProps(resolved),
    };
  }
}
...
export interface ContentItemProps {
   ...
   *
   * @schema ContentItem#spec
   */
  readonly spec?: ContentItemSpec;

}

/**
 * Converts an object of type 'ContentItemProps' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ContentItemProps(obj: ContentItemProps | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'metadata': obj.metadata,
    'spec': toJson_ContentItemSpec(obj.spec),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
 ...
 * Defines the documentation to attach to the referenced resource.
 *
 * @schema ContentItemSpec
 */
export interface ContentItemSpec {
  /**
   * Content is the valid markdown content.
   *
   * @schema ContentItemSpec#content
   */
   ...
   *
   * @schema ContentItemSpec#link
   */
  readonly link?: ContentItemSpecLink;

  /**
   * Order defines the order of the content in the UI.
   *
   * @schema ContentItemSpec#order
   */
   ...
   *
   * @schema ContentItemSpec#parentRef
   */
  readonly parentRef: ContentItemSpecParentRef;

  /**
   * Title is the public-facing name of the ContentItem.
   *
   * @schema ContentItemSpec#title
   */
  readonly title: string;
...
/**
 * Converts an object of type 'ContentItemSpec' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ContentItemSpec(obj: ContentItemSpec | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'content': obj.content,
    'link': toJson_ContentItemSpecLink(obj.link),
    'order': obj.order,
    'parentRef': toJson_ContentItemSpecParentRef(obj.parentRef),
    'title': obj.title,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
 ...
 * Link is the link to the content.
 *
 * @schema ContentItemSpecLink
 */
export interface ContentItemSpecLink {
  /**
   * Href is the public URL of the content.
   *
   * @schema ContentItemSpecLink#href
   */
...
/**
 * Converts an object of type 'ContentItemSpecLink' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ContentItemSpecLink(obj: ContentItemSpecLink | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'href': obj.href,
  };
 ...
 * ParentRef is the reference to the resource that this content belongs to.
 *
 * @schema ContentItemSpecParentRef
 */
export interface ContentItemSpecParentRef {
  /**
   * Kind is the kind of the resource that this content belongs to.
   *
   * @schema ContentItemSpecParentRef#kind
   */
  readonly kind: ContentItemSpecParentRefKind;

  /**
   * Name is the name of the resource that this content belongs to.
   *
   * @schema ContentItemSpecParentRef#name
   */
  readonly name: string;
...
/**
 * Converts an object of type 'ContentItemSpecParentRef' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_ContentItemSpecParentRef(obj: ContentItemSpecParentRef | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'kind': obj.kind,
    'name': obj.name,
 ...
 * Kind is the kind of the resource that this content belongs to.
 *
 * @schema ContentItemSpecParentRefKind
 */
export enum ContentItemSpecParentRefKind {
  /** APIPortal */
 ...
 *
 * @schema ManagedApplication
 */
export class ManagedApplication extends ApiObject {
  /**
   * Returns the apiVersion and kind for "ManagedApplication"
   */
  public static readonly GVK: GroupVersionKind = {
    apiVersion: 'hub.traefik.io/v1alpha1',
  ...
  /**
   * Renders a Kubernetes manifest for "ManagedApplication".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: ManagedApplicationProps = {}): any {
    return {
      ...ManagedApplication.GVK,
      ...toJson_ManagedApplicationProps(props),
    };
  }

  /**
   * Defines a "ManagedApplication" API object
   * @param scope the scope in which to define this object
   * @param id a scope-local name for the object
   * @param props initialization props
   */
  public constructor(scope: Construct, id: string, props: ManagedApplicationProps = {}) {
    super(scope, id, {
      ...ManagedApplication.GVK,
      ...props,
    });
  ...
  public toJson(): any {
    ...
    return {
      ...ManagedApplication.GVK,
      ...toJson_ManagedApplicationProps(resolved),
    };
  }
}
...
export interface ManagedApplicationProps {
  /**
   * @schema ManagedApplication#metadata
   */
  readonly metadata?: ApiObjectMetadata;
...
export function toJson_ManagedApplicationProps(obj: ManagedApplicationProps | undefined): Record<string, any> | undefined {
  ...
  const result = {
    'metadata': obj.metadata,
    'spec': toJson_ManagedApplicationSpec(obj.spec),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
...
export interface ManagedApplicationSpec {
   ...
   *
   * @schema ManagedApplicationSpec#apiKeys
   */
  readonly apiKeys?: ManagedApplicationSpecApiKeys[];

  /**
   * AppID is the identifier of the ManagedApplication.
   * It should be unique.
   *
   * @schema ManagedApplicationSpec#appId
   */
   ...
   *
   * @schema ManagedApplicationSpec#notes
   */
...
export function toJson_ManagedApplicationSpec(obj: ManagedApplicationSpec | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'apiKeys': obj.apiKeys?.map(y => toJson_ManagedApplicationSpecApiKeys(y)),
    'appId': obj.appId,
    'notes': obj.notes,
    'owner': obj.owner,
  };
...
export interface ManagedApplicationSpecApiKeys {
   ...
   *
   * @schema ManagedApplicationSpecApiKeys#secretName
   */
  readonly secretName?: string;

  /**
   * @schema ManagedApplicationSpecApiKeys#suspended
   */
  readonly suspended?: boolean;

  /**
   * @schema ManagedApplicationSpecApiKeys#title
   */
  readonly title?: string;
...
export interface ManagedSubscriptionSpec {
   ...
   *
   * @schema ManagedSubscriptionSpec#managedApplications
   */
  readonly managedApplications?: ManagedSubscriptionSpecManagedApplications[];
...
export function toJson_ManagedSubscriptionSpec(obj: ManagedSubscriptionSpec | undefined): Record<string, any> | undefined {
  ...
  const result = {
    ...
    'claims': obj.claims,
    'managedApplications': obj.managedApplications?.map(y => toJson_ManagedSubscriptionSpecManagedApplications(y)),
 ...
 *
 * @schema ManagedSubscriptionSpecManagedApplications
 */
 ...
 * @schema Uplink
 */
export class Uplink extends ApiObject {
  /**
   * Returns the apiVersion and kind for "Uplink"
   */
  public static readonly GVK: GroupVersionKind = {
    apiVersion: 'hub.traefik.io/v1alpha1',
    kind: 'Uplink',
  ...
  /**
   * Renders a Kubernetes manifest for "Uplink".
   *
   * This can be used to inline resource manifests inside other objects (e.g. as templates).
   *
   * @param props initialization props
   */
  public static manifest(props: UplinkProps = {}): any {
    return {
      ...Uplink.GVK,
      ...toJson_UplinkProps(props),
    };
  }

  /**
   * Defines a "Uplink" API object
   * @param scope the scope in which to define this object
   * @param id a scope-local name for the object
   * @param props initialization props
   */
  public constructor(scope: Construct, id: string, props: UplinkProps = {}) {
    super(scope, id, {
      ...Uplink.GVK,
      ...props,
    });
...
export interface UplinkProps {
   ...
   * @schema Uplink#spec
   */
  readonly spec?: UplinkSpec;

}

/**
 * Converts an object of type 'UplinkProps' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_UplinkProps(obj: UplinkProps | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'metadata': obj.metadata,
    'spec': toJson_UplinkSpec(obj.spec),
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
}
...
export interface UplinkSpec {
   ...
   *
   * @schema UplinkSpec#healthCheck
   */
  readonly healthCheck?: UplinkSpecHealthCheck;

  /**
   * PassiveHealthCheck configures the passive health check on the parent cluster for this uplink's load balancer.
   *
   * @schema UplinkSpec#passiveHealthCheck
   */
  readonly passiveHealthCheck?: UplinkSpecPassiveHealthCheck;

  /**
   * Weight for WRR on the parent.
   *
   * @schema UplinkSpec#weight
   */
  readonly weight?: number;
...
/**
 * Converts an object of type 'UplinkSpec' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_UplinkSpec(obj: UplinkSpec | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
    'entryPoints': obj.entryPoints?.map(y => y),
    'exposeName': obj.exposeName,
    'healthCheck': toJson_UplinkSpecHealthCheck(obj.healthCheck),
    'passiveHealthCheck': toJson_UplinkSpecPassiveHealthCheck(obj.passiveHealthCheck),
    'weight': obj.weight,
  };
  // filter undefined values
  return Object.entries(result).reduce((r, i) => (i[1] === undefined) ? r : ({ ...r, [i[0]]: i[1] }), {});
 ...
 * HealthCheck configures the active health check on the parent cluster for this uplink's load balancer.
 *
 * @schema UplinkSpecHealthCheck
 */
export interface UplinkSpecHealthCheck {
  /**
   * FollowRedirects defines whether redirects should be followed during the health check calls.
   * Default: true
   *
   * @schema UplinkSpecHealthCheck#followRedirects
   */
   ...
   *
   * @schema UplinkSpecHealthCheck#headers
   */
  readonly headers?: { [key: string]: string };
   ...
   *
   * @schema UplinkSpecHealthCheck#hostname
   */
   ...
   * Default: 30s
   *
   * @schema UplinkSpecHealthCheck#interval
   */
  readonly interval?: UplinkSpecHealthCheckInterval;

  /**
   * Method defines the healthcheck method.
   *
   * @schema UplinkSpecHealthCheck#method
   */
   ...
   * Default: http
   *
   * @schema UplinkSpecHealthCheck#mode
   */
   ...
   *
   * @schema UplinkSpecHealthCheck#path
   */
  readonly path?: string;
   ...
   *
   * @schema UplinkSpecHealthCheck#port
   */
   ...
   *
   * @schema UplinkSpecHealthCheck#scheme
   */
   ...
   *
   * @schema UplinkSpecHealthCheck#status
   */
   ...
   * Default: 5s
   *
   * @schema UplinkSpecHealthCheck#timeout
   */
  readonly timeout?: UplinkSpecHealthCheckTimeout;
   ...
   * Default: 30s
   *
   * @schema UplinkSpecHealthCheck#unhealthyInterval
   */
  readonly unhealthyInterval?: UplinkSpecHealthCheckUnhealthyInterval;

}

/**
 * Converts an object of type 'UplinkSpecHealthCheck' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_UplinkSpecHealthCheck(obj: UplinkSpecHealthCheck | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
 ...
 * PassiveHealthCheck configures the passive health check on the parent cluster for this uplink's load balancer.
 *
 * @schema UplinkSpecPassiveHealthCheck
 */
export interface UplinkSpecPassiveHealthCheck {
  /**
   ...
   *
   * @schema UplinkSpecPassiveHealthCheck#failureWindow
   */
  readonly failureWindow?: UplinkSpecPassiveHealthCheckFailureWindow;
   ...
   *
   * @schema UplinkSpecPassiveHealthCheck#maxFailedAttempts
   */
...
/**
 * Converts an object of type 'UplinkSpecPassiveHealthCheck' to JSON representation.
 */
/* eslint-disable max-len, quote-props */
export function toJson_UplinkSpecPassiveHealthCheck(obj: UplinkSpecPassiveHealthCheck | undefined): Record<string, any> | undefined {
  if (obj === undefined) { return undefined; }
  const result = {
 ...
 * Default: 30s
 *
 * @schema UplinkSpecHealthCheckInterval
 */
export class UplinkSpecHealthCheckInterval {
  public static fromNumber(value: number): UplinkSpecHealthCheckInterval {
    return new UplinkSpecHealthCheckInterval(value);
  }
  public static fromString(value: string): UplinkSpecHealthCheckInterval {
    return new UplinkSpecHealthCheckInterval(value);
  }
 ...
 * Default: 5s
 *
 * @schema UplinkSpecHealthCheckTimeout
 */
export class UplinkSpecHealthCheckTimeout {
  public static fromNumber(value: number): UplinkSpecHealthCheckTimeout {
    return new UplinkSpecHealthCheckTimeout(value);
  }
  public static fromString(value: string): UplinkSpecHealthCheckTimeout {
    return new UplinkSpecHealthCheckTimeout(value);
  }
  private constructor(public readonly value: number | string) {
  }
 ...
 * Default: 30s
 *
 * @schema UplinkSpecHealthCheckUnhealthyInterval
 */
export class UplinkSpecHealthCheckUnhealthyInterval {
  public static fromNumber(value: number): UplinkSpecHealthCheckUnhealthyInterval {
    return new UplinkSpecHealthCheckUnhealthyInterval(value);
  }
  public static fromString(value: string): UplinkSpecHealthCheckUnhealthyInterval {
    return new UplinkSpecHealthCheckUnhealthyInterval(value);
  }
  private constructor(public readonly value: number | string) {
  }
 ...
 * FailureWindow defines the time window during which the failed attempts must occur for the server to be marked as unhealthy. It also defines for how long the server will be considered unhealthy.
 *
 * @schema UplinkSpecPassiveHealthCheckFailureWindow
 */
export class UplinkSpecPassiveHealthCheckFailureWindow {
  public static fromNumber(value: number): UplinkSpecPassiveHealthCheckFailureWindow {
    return new UplinkSpecPassiveHealthCheckFailureWindow(value);
  }
  public static fromString(value: string): UplinkSpecPassiveHealthCheckFailureWindow {
    return new UplinkSpecPassiveHealthCheckFailureWindow(value);
  }
  private constructor(public readonly value: number | string) {
  }
